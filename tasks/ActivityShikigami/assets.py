...
class ActivityShikigamiAssets: 
	...
	# 活动爬塔标志 
	I_CLIMB_MODE_PASS = RuleImage(roi_front=(1148,541,25,32), roi_back=(1129,510,48,69), threshold=0.8, method="Template matching", file="./tasks/ActivityShikigami/as/as_climb_mode_pass.png")
	# 体力爬塔标志 
	...
	# 切换按键 
	I_CLIMB_MODE_SWITCH = RuleImage(roi_front=(1232,541,32,34), roi_back=(1174,511,104,82), threshold=0.8, method="Template matching", file="./tasks/ActivityShikigami/as/as_climb_mode_switch.png")


	# Image Rule Assets
	# 进入活动 
	I_SHI = RuleImage(roi_front=(1180,381,54,48), roi_back=(1164,134,83,393), threshold=0.7, method="Template matching", file="./tasks/ActivityShikigami/as/as_shi.png")
	# 左上角返回 
	...
	# 进入主要的战斗界面 
	I_TO_BATTLE_MAIN = RuleImage(roi_front=(246,300,32,150), roi_back=(180,240,240,320), threshold=0.8, method="Template matching", file="./tasks/ActivityShikigami/as/as_to_battle_main.png")
	# 点击进入boss战斗页面 
	...
	# description 
	I_CHECK_BATTLE_MAIN = RuleImage(roi_front=(150,14,135,43), roi_back=(120,0,220,70), threshold=0.8, method="Template matching", file="./tasks/ActivityShikigami/as/as_check_battle_main.png")
	# description 
	...
	# Ocr Rule Assets
	# 挑战 
	O_FIRE = RuleOcr(roi=(1136,605,78,52), area=(1104,584,150,112), mode="Single", method="Default", keyword="挑战", name="fire")
	# 体力的数量检测 
	O_REMAIN_AP = RuleOcr(roi=(268,588,100,35), area=(230,588,140,35), mode="Digit", method="Default", keyword="", name="remain_ap")
	# 活动体力的剩余检测 
	O_REMAIN_PASS = RuleOcr(roi=(598,16,62,32), area=(598,16,62,32), mode="Digit", method="Default", keyword="", name="remain_pass")
	# 还有多少次购买体力的机会 
